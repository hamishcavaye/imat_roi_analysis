...
1. Dark/flat frame correction
2. Parsing of data from a mass spectrometer
3. Parsing of temperature logs
4. Image calibration and ROI extraction
5. Multi-run time-aligned figure plotting
